...
var TestPage = (function () {
    function TestPage(loadingCtrl, alertCtrl, navCtrl, navParams, dataService, toastCtrl, tematicas, formBuilder) {
        var _this = this;
    ...
    TestPage.prototype.siguientePregunta = function () {
        var _this = this;
        ...
        if (this.contador == this.size) {
            ...
            var hideFooterTimeout = setTimeout(function () {
                _this.navCtrl.push('ResultadoPage', {
                    ...
                    sizeTest: _this.size,
                    correctas: _this.contarCorrecta,
